...
{
    // https://stackoverflow.com/questions/33594802/how-can-i-display-in-a-middle-of-a-progressbar-some-text
    ...
    public class TextProgressBar : ProgressBar
    {
        ...
        private string _percentageStr { get { return $"{Math.Truncate(((float)Value - Minimum) / ((float)Maximum - Minimum) * 100)} %"; } }

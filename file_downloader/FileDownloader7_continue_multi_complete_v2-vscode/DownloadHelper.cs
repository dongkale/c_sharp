...
//     public static async Task DownloadFileAsync(FileDownloaderItem item, int partCount = DEFAULT_FILE_PART_COUNT)
//     {
//         long totalFileSize = 0;
//         long totalBytesReceived = item.TotalBytesReceived;
...
//                     item.UpdateStatus("파일이 이미 완전히 다운로드되었습니다.");
//                     return;
//                 }
...
//             catch (Exception ex)
//             {
//                 item.UpdateStatus("다운로드 오류: " + ex.Message);
//             }
//         }
//     }

//     private static async Task DownloadPartAsync(FileDownloaderItem item, long start, long end, int partIndex)
//     {
//         string tempFilePath = $"{item.DownloadPath}.part{partIndex}";
//         long existingLength = 0;
